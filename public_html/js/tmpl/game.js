define(function () {
	return function (__fest_context) {
		...
		__fest_buf += ("<div><div class=\"hello\"><p>Hello, ");
		try {
			__fest_buf += (__fest_escapeHTML(json.login))
		} catch (e) {
			__fest_log_error(e.message + "3");
		}
		__fest_buf += ("</p></div><div class=\"wait\"><p>Prepare yourself. Wait for enemy!</p></div><div class=\"gameplay\" style=\"display: none\"><div class=\"score\"><p>");
		try {
			__fest_buf += (__fest_escapeHTML(json.login))
		} catch (e) {
			__fest_log_error(e.message + "12");
		}
		__fest_buf += (": <span id=\"myScore\">0</span></p><p><span id=\"enemyName\"></span>: <span id=\"enemyScore\">0</span></p></div></div><div class=\"gameOver\" style=\"display: none\"><p>Game over! You are<span id=\"win\"></span></p><p>Result:<span id=\"win\"></span></p></div></div><canvas width=\"600\" height=\"700\" id=\"gamefield\"></canvas>");
		var __fest_context0;
		try {
